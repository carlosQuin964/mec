...
<head>
  ...
  <style>.navbar-inverse{background: #F29C0B;}</style>
...
<div version="2.0" id="header">
    ...
    <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav" id="_menu">
         <li><a href="listcustomer.php">View users</a></li>
...
<nav class="navbar navbar-default navbar-fixed-top">
  ...
  <div class="collapse navbar-collapse global-navbar-collapse">
    <ul class="nav navbar-nav" id="home">
      <li class=""><a href="Ahome.php">Home</a></li>
  ...
  <nav class="navbar navbar-inverse sidebar navbar-fixed-top" role="navigation">
      ...
      <div class="collapse navbar-collapse view-navbar-collapse">
        <ul class="nav navbar-nav" id="homes">
                  <li class=""><a href="Ahome.php">home<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-align-justify"></span></a></li>
          ...
          <li class="dropdown last">
            <a href="viewExam.php" class="dropdown-toggle" data-toggle="dropdown">users <span class="caret"></span><span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-list-alt"></span></a>
            <ul class="dropdown-menu forAnimate" role="menu">
          <li><a href="listcustomer.php">view user</a></li>
          <li><a href="addTeacher.php">Create Teacher</a></li>
