...
<th>Add</th>
	...
	echo'
		...
		<td> <button type="button" class="btn btn-danger esto" id="'.$idcurso.'" onclick="eliminar('.$idcurso.')">Delete</button>
		</td>
		<td>
	 	<a href="courSubj.php?id='.$idcurso.'"><button class="btn btn-info" id="'.$idcurso.'" >Add Subject</button></a></td>
		</tr>
		';
	 }
	 	?>
...
<a href="PDF/coursePDF.php"><button class="btn btn-warning btn-lg col-md-12">All Courses</button></a>
	</div>
